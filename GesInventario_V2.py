...
def guardarProducto(nombre,precio,stock):
    if buscarProducto == None:
        ...
        return "Se ha guardado correctamente el producto"
    else:
        return "Un producto con ese nombre ya se encuentra en la lista."
        
        
    
    #return escondido lel
...
def mostarInventarioCompleto():
    ...
    if(len(lista_productos)==0):
        ...
        for producto in lista_productos:
            print(f"Nombre: {producto["nombre"]} \t Precio: ${producto["precio"]} \t Stock: {producto["stock"]} unidades")
